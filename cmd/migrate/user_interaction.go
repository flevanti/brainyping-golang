...
func showPendingMigrations() {
	...
	utilities.PrintTable([]string{"SEQUENCE", "NAME", "UNIQUEID", "CONNECTION"}, tableData)
}
...
func showRegisteredMigrations() {
	...
	utilities.PrintTable([]string{"SEQUENCE", "NAME", "UNIQUEID", "CONNECTION", "PENDING", "PROCESSED AT", "BATCH"}, tableData)
...
func showProcessedMigrations() {
	...
	utilities.PrintTable([]string{"SEQUENCE", "NAME", "UNIQUEID", "CONNECTION", "PROCESSED AT", "BATCH", "MS", "MONGO _ID"}, tableData)
...
func showConnectionsLabels() {
	...
	utilities.PrintTable([]string{"CONNECTION LABEL", "DESCRIPTION"}, tableData)
}
