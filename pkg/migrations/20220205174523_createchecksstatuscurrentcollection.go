...
func down_20220205174523(db *mongo.Client) error {
	err := db.Database(dbhelper.GetDatabaseName()).Collection(dbhelper.TablenameChecksStatus).Drop(nil)
	if err != nil {
		return err
	}
	return nil
...
//
func init() {
	bisonmigration.RegisterMigration(20220205174523, "createchecksstatuscurrentcollection", "*DEFAULT*", up_20220205174523, down_20220205174523)
}
